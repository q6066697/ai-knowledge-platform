...
async def retrieve(session: AsyncSession, question: str, top_k: int) -> list[SearchResult]:
    ...
    if settings.ENABLE_HYBRID_SEARCH:
        ...
        pool_size = settings.RERANK_CANDIDATES if settings.ENABLE_RERANKING else top_k
